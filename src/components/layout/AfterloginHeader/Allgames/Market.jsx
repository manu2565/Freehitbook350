...
function Market() {
  return (
    ...
    >
      <div data-v-ef40c19a data-v-cb9ac2ee className="inplay_container">
        <div data-v-ef40c19a>
          <ul
            data-v-ef40c19a
            id="pills-tab"
            role="tablist"
            className="nav nav-pills topbar mb-2"
          >
            <li data-v-ef40c19a role="presentation" className="nav-item">
              <Link
                data-v-ef40c19a
                id="pills-sports-market-tab"
                data-toggle="pill"
                to="#pills-sports-market"
                role="tab"
                aria-controls="pills-sports-market"
                aria-selected="true"
            ...
            <li data-v-ef40c19a role="presentation" className="nav-item">
              <Link
                data-v-ef40c19a
                id="pills-worli-market-tab"
                data-toggle="pill"
                to="#pills-worli-market"
                role="tab"
                aria-controls="pills-worli-market"
                aria-selected="false"
                className="nav-link"
              >
                Matka Market
          ...
          <div data-v-ef40c19a id="pills-tabContent" className="tab-content">
            <div
              data-v-ef40c19a
              id="pills-sports-market"
              role="tabpanel"
              aria-labelledby="pills-sports-market-tab"
              className="tab-pane fade active show"
            >
              <div data-v-ef40c19a className="table_container">
                <table data-v-ef40c19a className="table mb-0">
                  <thead data-v-ef40c19a>
                    <tr data-v-ef40c19a>
                      <th data-v-ef40c19a scope="col">
                        SPORTS
                      </th>{" "}
                      <th data-v-ef40c19a scope="col">
                        EVENT
                  ...
                  <tbody data-v-ef40c19a>
                    {" "}
                    <tr data-v-ef40c19a>
                      <td data-v-ef40c19a colSpan={4}>
                        No Records Found.
                      </td>
                    </tr>
                  </tbody>
      ...
      >
        ...
        >
          <div data-v-cb9ac2ee className="modal-content bg-transparent border-0">
            <div data-v-cb9ac2ee className="modal-header bg-transparent border-0">
              <button
                data-v-cb9ac2ee
                type="button"
                id="closeFirstPopup"
          ...
          <div data-v-687fd205 className="d-flex align-items-center h-100">
            ...
            >
              ...
              <li data-v-687fd205 role="presentation" className="nav-item">
                <Link data-v-687fd205 to="" className="nav-link">
                                  ...
                                  <div data-v-687fd205 className="card-body p-1">
                                    ...
                                    >
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Northern Brave Women v Canterbury
                                              Magicians Women
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Wellington Blaze Women v Auckland
                                              Hearts Women
                                            </button>
                                          </div>
                                        </div>
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Wellington Firebirds v Auckland
                                              Aces
                                            </button>
                                          </div>
                                        </div>
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Gulf Giants v Abu Dhabi Knight
                                              Riders
                                            </button>
                                            <button
                                              data-v-687fd205
                                        ...
                                        >
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Surrey Kings v Cornwall Warriors
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Surrey Risers v Surrey Royals
                                            </button>
                                          </div>
                                        </div>
                                      </div>
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnercricket1380"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnercricket1380"
                                            aria-expanded="false"
                                            aria-controls="collapseInnercricket1380"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                        ...
                                        <div
                                          data-v-687fd205
                                          id="collapseInnercricket1380"
                                          aria-labelledby="headingInnercricket1380"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                  ...
                                  <div data-v-687fd205 className="card-body p-1">
                                    ...
                                    >
                                      ...
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnersoccer75"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnersoccer75"
                                            aria-expanded="false"
                                            aria-controls="collapseInnersoccer75"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                        ...
                                        <div
                                          data-v-687fd205
                                          id="collapseInnersoccer75"
                                          aria-labelledby="headingInnersoccer75"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                      ...
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnersoccer685"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnersoccer685"
                                            aria-expanded="false"
                                            aria-controls="collapseInnersoccer685"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                        ...
                                        <div
                                          data-v-687fd205
                                          id="collapseInnersoccer685"
                                          aria-labelledby="headingInnersoccer685"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Hong Kong Rangers FC v Lee Man
                                              Warriors
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Hong Kong FC v Kowloon City FC
                                            </button>
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        >
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Goztepe v Antalyaspor
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Konyaspor v Kasimpasa
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Eyupspor v Alanyaspor
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                      ...
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnersoccer217"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnersoccer217"
                                            aria-expanded="false"
                                            aria-controls="collapseInnersoccer217"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                              className="plus-icon"
                                            />
                                            Spanish Women's Matches
                                          </button>
                                        </div>{" "}
                                        <div
                                          data-v-687fd205
                                          id="collapseInnersoccer217"
                                          aria-labelledby="headingInnersoccer217"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Real Sociedad (W) v Espanyol (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Real Madrid FC (W) v SD Eibar (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Sevilla FC (W) v Betis (W)
                                            </button>
                                          </div>
                                        </div>
                                      </div>
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnersoccer68"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnersoccer68"
                                            aria-expanded="false"
                                            aria-controls="collapseInnersoccer68"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                        ...
                                        <div
                                          data-v-687fd205
                                          id="collapseInnersoccer68"
                                          aria-labelledby="headingInnersoccer68"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Sampdoria (W) v AC Milan (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Inter Milan (W) v Como FC (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              AS Roma (W) v Juventus FC (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              SSD Fiorentina WFC (W) v Sassuolo
                                              (W)
                                            </button>
                                          </div>
                                        </div>
                                        ...
                                        >
                                          ...
                                          >
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Tottenham (W) v Leicester City (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Arsenal (W) v Crystal Palace (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              West Ham United (W) v Chelsea (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Man City (W) v Man Utd (W)
                                            </button>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div data-v-687fd205 className="card">
                                        <div
                                          data-v-687fd205
                                          id="headingInnersoccer127"
                                        >
                                          <button
                                            data-v-687fd205
                                            type="button"
                                            data-toggle="collapse"
                                            data-target="#collapseInnersoccer127"
                                            aria-expanded="false"
                                            aria-controls="collapseInnersoccer127"
                                            className="btn-block text-left"
                                          >
                                            <span
                                              data-v-687fd205
                                              className="plus-icon"
                                            />
                                            English Women's Matches
                                          </button>
                                        </div>{" "}
                                        <div
                                          data-v-687fd205
                                          id="collapseInnersoccer127"
                                          aria-labelledby="headingInnersoccer127"
                                          data-parent="#accordionInner"
                                          className="collapse"
                                        >
                                          <div
                                          ...
                                          >
                                            ...
                                            <button
                                              ...
                                              className="btn-block"
                                            >
                                              Portsmouth (W) v Birmingham (W)
                                            </button>
                                            <button
                                              data-v-687fd205
                                              className="btn-block"
                                            >
                                              Southampton (W) v Sunderland (W)
                                            </button>
                                          </div>
                                        </div>
                                      </div>
              ...
              <li data-v-687fd205 role="presentation" className="nav-item">
                <Link data-v-687fd205 to="/games/live-casino" className="nav-link">
                  <div
                    data-v-687fd205
                    className="d-flex flex-column justify-content-center h-100 align-items-center text-nowrap"
                  >
